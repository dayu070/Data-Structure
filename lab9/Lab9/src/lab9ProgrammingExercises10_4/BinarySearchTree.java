package lab9ProgrammingExercises10_4;
...
public class BinarySearchTree<E> extends AbstractSet<E> 
{
	...
	protected boolean addElement(Entry<E> p, E element)
	{
		if (root == null)
		{
			if(element == null)
		...
		else 
        {
            ...
            int comp;
                ...
                if (comp < 0)
                    if (temp.left != null)
                        return addElement(temp.left, element);
                    else 
                    {
                        temp.left = new Entry<E> (element, temp);
                        size++;                             
                    	...
                    	return addElement(temp.right, element);
                    else 
                    {
                        temp.right = new Entry<E> (element, temp);
                        size++;                           
