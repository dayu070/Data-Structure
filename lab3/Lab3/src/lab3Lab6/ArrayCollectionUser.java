...
public class ArrayCollectionUser {
	protected ArrayCollection<String> a1,
                                      a2;  
	public static void main(String[] args) {
     ...
     {           
	     ...
	     "method identifier " +
             "and, if applicable, the argument (or " + SENTINEL + " to quit): ";
     ...
     {              
         ...
         final String ADDED = 
             " has been added to the ArrayCollection.";
             
         final String CONTAINED = 
             " is contained in the ArrayCollection.";
    
         final String NOT_CONTAINED =
             " is not contained in the ArrayCollection.";
         ...
         final String NOT_REMOVED = 
             " was not removed because it is not in the ArrayCollection.";
         ...
         ArrayCollection<String> callingObject = null,
                                 argument;
