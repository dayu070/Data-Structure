...
public class RunTimeTest {
	...
	public void run() throws FileNotFoundException
	{
		...
		ComparableSorts.heapSort(s1);
        finishTime = System.nanoTime();
        elapsedTime = finishTime - startTime;
        System.out.println ("The heap sort: " + MESSAGE_1 + threeDigits.format((elapsedTime / NANO_FACTOR)) + MESSAGE_2);
        
        startTime = System.nanoTime();
        ComparableSorts.mergeSort(s2);
        finishTime = System.nanoTime();
        elapsedTime = finishTime - startTime;
        System.out.println ("The merge sort: " + MESSAGE_1 + threeDigits.format((elapsedTime / NANO_FACTOR)) + MESSAGE_2);
        
        startTime = System.nanoTime();
        ComparableSorts.quickSort(s3);	
        finishTime = System.nanoTime();
        elapsedTime = finishTime - startTime;
        System.out.println ("The quick sort: " + MESSAGE_1 + threeDigits.format((elapsedTime / NANO_FACTOR)) + MESSAGE_2);
	}
